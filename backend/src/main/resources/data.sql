...
-- Students
INSERT IGNORE INTO students (id, name, email, password, cgpa, branch, active_backlogs, skills, certifications, resume_url) 
VALUES (1, 'Anisha Paturi', 'anisha@college.edu', 'student123', 9.2, 'CSE', 0, 'Java, Spring Boot, React, SQL', 'AWS Cloud Practitioner', 'resume_anisha.pdf');

INSERT IGNORE INTO students (id, name, email, password, cgpa, branch, active_backlogs, skills, certifications, resume_url) 
VALUES (2, 'John Doe', 'john@college.edu', 'student123', 8.5, 'IT', 0, 'Python, Django, React', 'Google Data Analytics', 'resume_john.pdf');

INSERT IGNORE INTO students (id, name, email, password, cgpa, branch, active_backlogs, skills, certifications, resume_url) 
VALUES (3, 'Jane Smith', 'jane@college.edu', 'student123', 7.8, 'ECE', 1, 'C++, Embedded Systems', 'IoT Certification', 'resume_jane.pdf');

INSERT IGNORE INTO students (id, name, email, password, cgpa, branch, active_backlogs, skills, certifications, resume_url) 
VALUES (4, 'Michael Brown', 'michael@college.edu', 'student123', 6.5, 'MECH', 2, 'AutoCAD, SolidWorks', 'None', 'resume_michael.pdf');
